...
if WeedSpotSpray ~= nil and WeedSpotSpray.updateExtendedSprayerNozzleEffectState ~= nil then
    WeedSpotSpray.updateExtendedSprayerNozzleEffectState = Utils.overwrittenFunction(
        WeedSpotSpray.updateExtendedSprayerNozzleEffectState,
        function(self, superFunc, effectData, dt, isTurnedOn, lastSpeed)
