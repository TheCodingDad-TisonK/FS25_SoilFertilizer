...
SoilHelpDialog.CONTENT = {
    -- ── LEFT COLUMN ──────────────────────────────────────
    { t="H", v="NUTRIENTS" },
    { t="B", v="N  (Nitrogen)     Drops on every harvest." },
    { t="B", v="   Apply UAN, Urea, AMS, AN, or Manure." },
    { t="B", v="P  (Phosphorus)   Slow-moving, long lasting." },
    { t="B", v="   Apply MAP, DAP, or Polifoska." },
    { t="B", v="K  (Potassium)    Key for root crops." },
    { t="B", v="   Apply Potash or Liquid Potash." },
    { t="B", v="OM (Organic Matter) Builds slowly." },
    { t="B", v="   Work in Manure, Compost, or Biosolids." },
    { t="S", v=" " },
    { t="H", v="SOIL CHEMISTRY" },
    { t="B", v="pH 6.5 to 7.0 is the ideal range." },
    { t="B", v="Below 6.5 is acidic - apply Lime." },
    { t="B", v="Above 7.5 is alkaline - apply Gypsum." },
    { t="B", v="Allow 1 to 2 seasons to settle after treating." },
    { t="S", v=" " },
    { t="H", v="CROP TARGETS" },
    { t="B", v="Each crop has its own N / P / K needs." },
    { t="B", v="The map shows the gap between your current" },
    { t="B", v="level and the planted crop's target." },
    { t="B", v="Green = at or above target." },
    { t="B", v="Red = a deficit. Click a map cell to inspect." },
    -- ── COLUMN BREAK ─────────────────────────────────────
    { t="COL", v="" },
    -- ── RIGHT COLUMN ─────────────────────────────────────
    { t="H", v="STATUS LEVELS" },
    { t="B", v="Good (green)   At or above optimal." },
    { t="B", v="Fair (yellow)  Below optimal - plan a top-up." },
    { t="B", v="Poor (red)     Below minimum - act now." },
    { t="S", v=" " },
    { t="H", v="FIELD HEALTH" },
    { t="B", v="Weed    > 20%  Spray Herbicide, or hoe it." },
    { t="B", v="Pest    > 20%  Spray Insecticide." },
    { t="B", v="Disease > 20%  Spray Fungicide, or Scout the" },
    { t="B", v="   field to name the disease and pick a" },
    { t="B", v="   targeted product for it." },
    { t="S", v=" " },
    { t="H", v="TIPS" },
    { t="B", v="Treatment Plan tab lists fields worst-first." },
    { t="B", v="Heavy vehicles compact soil - a subsoiler" },
    { t="B", v="   pass relieves it." },
    { t="B", v="Rain leaches N - avoid heavy N before rain." },
    { t="B", v="Legumes (soy, peas) leave an N bonus next" },
    { t="B", v="   season. Rotate crops to avoid fatigue." },
}
